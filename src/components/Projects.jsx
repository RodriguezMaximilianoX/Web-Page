    ...
    <section className=''>
      ...
      <div className='flex justify-around'>
        <div className='flex flex-col rounded-lg p-4 bg-blue-950'>
          <h4 className='font-bold text-center text-white'>Ecommerce</h4>
          ...
          <p className='text-white overflow-hidden max-w-xs text-center'>Proyecto desarrollado con React y CSS. Es una simulacion de un ecommerce con carrito de compras y seccion de pago</p>
